<script lang="ts">
  import HomeIcon from '#/lib/heroicons/outline/HomeIcon.svelte';
  let isSolutionsOpen: boolean = false;
  let isMoreOpen: boolean = false;
  ...
  function handleFocusLost({ relatedTarget, currentTarget }: { relatedTarget: EventTarget | null; currentTarget: HTMLElement }): void {
...
<div class="relative bg-white">
  ...
  <div class="relative z-20">
    <div class="mx-auto flex max-w-7xl items-center justify-between py-5 px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
      <!-- This is the mobile view div -->
      <div class="-my-2 -mr-2 md:hidden" on:focusout={handleFocusLost}>
        <button
          type="button"
      ...
      <div class="hidden md:flex md:flex-1 md:items-center md:justify-between">
        <nav class="flex space-x-10">
          <div on:focusout={handleFocusLost}>
            ...
            <button
              ...
              aria-expanded="false"
              on:click={solutionsToggle}
            >
              <span><HomeIcon />Solutions</span>
              <!--
      ...
      <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
        <div class="px-5 pt-5 pb-6 sm:pb-8">
          ...
          <div class="mt-6 sm:mt-8">
            <nav>
              <div class="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4" on:focusout={handleFocusLost}>
