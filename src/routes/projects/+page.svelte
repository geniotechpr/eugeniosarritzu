...
<div class="relative flex w-full">
  <div class="flex flex-col">
    ...
    <span class="mx-auto mb-2 flex text-lg font-medium tracking-tight text-zinc-800 dark:text-zinc-300"> In Progress...</span>
    <span class="mb-6 text-left text-base tracking-tight text-zinc-800 dark:text-zinc-300"
    ...
    <span class="mx-auto mb-6 text-left text-base tracking-tight text-zinc-800 dark:text-zinc-300">
    ...
    <div class="mb-6 flex justify-around rounded bg-zinc-200/30 shadow-lg shadow-zinc-800/5 dark:bg-zinc-800/75">
      <span class="p-2 text-left text-base font-medium tracking-tight text-zinc-600 dark:text-zinc-400 xs:text-base">
        During the rest of 2023, I want to spend more of my time online <em>creating</em> instead of <em>consuming</em>.
      </span>
    </div>
    <span class="mb-1.5 text-left text-base tracking-tight text-zinc-800 dark:text-zinc-300">
